...
module.exports = class {
    ...
    async run(client, message, args) {
        try{
            ...
            **x!info** - Get Information about Mirror Mage
            **x!invite** - Invite Mirror Mage
            **x!leave** - Let the bot leave
            **x!ping** - Pong
            
            `)
            .setFooter(`Use x!help [command] for more info on a command. You can also use x!help [category] for more info on a category.`)
            .setColor("#5DBCD2")
            ...
            if(args[1] === "backup") {
                const embed = new RichEmbed()
                    .setTitle(`**x!backup** - Create & load backups of your servers
